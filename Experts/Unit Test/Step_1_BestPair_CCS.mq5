...
struct report1_orders_info_struct{string currency; long pos_id; double price; long pos_magic ;string comment; datetime dt; report1_orders_info_struct(){currency="";pos_id = 0; price =0.0; pos_magic = "5652534"; comment = ""; dt = 0;}};
...
void printOrderInfo(){
   for (int i = 0; i < ArraySize(pairs); i++) {    
      ...
      text1[i] = text1[i] + report_orders[i].price;
